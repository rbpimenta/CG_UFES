...
class Transformacao
{
	public:
		...
		void definirTransformacao (float fatorEscala, float cx, float cy, float cz, float raio, float anguloGiro, float anguloMira, float height, float posX, float posY);
		void iniciarTransformacao(bool ehTiro, bool vision3d);
